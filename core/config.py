...
LEGACY_PRESETS = {
    ...
    "🔬 b14+b6 吞噬+超賣": {
        "desc": "【📚 LEGACY 移入 2026-05-15】b14（低位吞噴）AND b6（RSI<30）雙確認。"
...
BUY_LABELS = [
    ...
    "Ⓑ13 縮量反轉",     "Ⓑ14 低位吞噴",    "Ⓑ15 長下影線",    "Ⓑ16 下影線資金流入",
