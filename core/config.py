...
#
#   ② b14 低位吞噷 溫和降權（MC 連四輪證據最弱：Sharpe 0.176 全場最低、
...
ACTIVE_PRESETS = {
    ...
    "💎 b14 低位吞噷": {
        "desc": "【💎 PIT 驗證通過｜⚠️ V22.2 降權：輕倉】低位半吞噷形態："
...
LIGHT_POSITION_PRESETS = {
    ...
    "💎 b14 低位吞噷",               # V22.2：MC 連四輪最弱（Sharpe 0.176、回撤 -88.7%），高波動降權
}